...
def main(
    ...
    if test_dataset is not None:
        ...
        # 这里假设predictions.predictions已经是我们想要处理的形式
        # 如果predictions.predictions是logits，则需要首先转换它们
    ...
    # 转换预测结果为文本
    # predicted_texts = tokenizer.batch_decode(predictions.predictions.argmax(-1), skip_special_tokens=True)
